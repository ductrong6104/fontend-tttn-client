...
export default function ItemInforAccount({type, name, value, onChange, placeholder, onClickButton, labelInput, labelButton}){
    return (
        <div className="flex rounded-md border-2 p-2 mb-2 justify-between">
            ...
            <div className="flex items-center">
                ...
                <button className="bg-purple-100 p-2 pl-8 rounded-md end-0" onClick={onClickButton}>{labelButton}</button>
            </div>
        </div>
    )
}